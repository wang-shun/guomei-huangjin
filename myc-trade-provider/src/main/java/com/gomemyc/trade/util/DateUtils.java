...
public class DateUtils {
    ...
    public static final DateTimeFormatter dateTimeFormatter = DateTimeFormat.forPattern("yyyy年MM月dd日 HH:mm:ss");
...
//    	System.out.println(countHours(new Date(), offsetDaysByInt(new Date(), 3)));
        System.out.println(formatDate(new Date(), dateTimeFormatter));
