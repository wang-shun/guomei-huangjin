...
/** 
 * ClassName:GoldDueAccountCheckDTO
 ...
 * @description 
 */
public class GoldDueAccountCheckDTO implements Serializable{


	private static final long serialVersionUID = 6960531241398257612L;
    ...
    public GoldDueAccountCheckDTO() {
    }

    public GoldDueAccountCheckDTO(String id, String reqNo, String orderNo, Date goldOrderTime, Date goldFinishTime,
