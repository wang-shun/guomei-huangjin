...
public enum GoldInfoCode {
	...
	PRODUCT_RULES_NOT_EXIST(90002,"产品规则不存在"),
	 ...
	 * 合同模板
	 */
	CONTRACT_NOT_EXIST(95000,"黄金产品表中查询不到该对象"),
	CONTRACT_USER_NOT_EXIST(95001,"用户不存在"),
    CONTRACT_INVEST_ORDER_NOT_EXIST(95002,"订单不存在"),
	/**
	 * 黄金钱包
	 */
